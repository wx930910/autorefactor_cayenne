...
public class SelectQueryIT extends ServerCase {
	...
	public void testSelect_QualfierOnToMany() throws Exception {
		...
		List<Artist> objects = SelectQuery
				.query(Artist.class, Artist.PAINTING_ARRAY.dot(Painting.PAINTING_TITLE).like("P%")).select(context);
	...
	public void testSelectLongIn() throws Exception {
		...
		SelectQuery<Artist> query = new SelectQuery<>(Artist.class, ExpressionFactory.inExp("artistName", names));
	...
	public void testSelectLongNotIn() throws Exception {
		...
		SelectQuery<Artist> query = new SelectQuery<>(Artist.class, ExpressionFactory.notInExp("artistName", names));
		List<Artist> artists = query.select(context);
