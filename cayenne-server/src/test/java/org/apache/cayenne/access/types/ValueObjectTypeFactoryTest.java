...
public class ValueObjectTypeFactoryTest {
	...
	public void setUpRegistry() {
		...
		tstType2 = MockExtendedType.mockExtendedType2(String.class);
		extendedTypeMap.registerType(tstType2);

		tstType3 = MockExtendedType.mockExtendedType2(int.class);
		...
		tstType5 = MockExtendedType.mockExtendedType2(BigDecimal.class);
	...
	public void testUUIDtoByteArray() {
		ValueObjectTypeFactory.ExtendedTypeConverter converter1 = (ValueObjectTypeFactory.ExtendedTypeConverter) factory
				.getType(UUID.class);
	...
	public void testString() {
		ValueObjectTypeFactory.ExtendedTypeConverter converter2 = (ValueObjectTypeFactory.ExtendedTypeConverter) factory
	...
	@Test
	public void testInt() {
		ValueObjectTypeFactory.ExtendedTypeConverter converter3 = (ValueObjectTypeFactory.ExtendedTypeConverter) factory
				.getType(int.class);
	...
	public void testStringArray() {
		ValueObjectTypeFactory.ExtendedTypeConverter converter4 = (ValueObjectTypeFactory.ExtendedTypeConverter) factory
				.getType(String[].class);
	...
	public void testInheritantType() {
		ValueObjectTypeFactory.ExtendedTypeConverter converter5 = (ValueObjectTypeFactory.ExtendedTypeConverter) factory
