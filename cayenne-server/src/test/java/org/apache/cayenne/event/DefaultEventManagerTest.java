...
public class DefaultEventManagerTest implements EventListener {
	...
	static public CayenneEvent mockCayenneEvent1(EventListener l) {
		CayenneEvent mockInstance = Mockito.spy(new CayenneEvent(l));
		try {
	...
	public void testValidSubclassOfRegisteredEventClass() throws Exception {
		...
		eventManager.postEvent(DefaultEventManagerTest.mockCayenneEvent1(this), subject);
